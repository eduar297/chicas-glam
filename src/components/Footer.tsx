      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-2xl font-elegant font-bold text-rose-400 mb-4">
              Chicas Glam
            </h3>
            <p className="text-gray-300 mb-4">
              Tu belleza es nuestra pasión. Transformamos y resaltamos lo mejor de ti.
            </p>
            <div className="flex justify-center md:justify-start space-x-4">
              <a
                ...
                className="bg-rose-600 hover:bg-rose-700 p-2 rounded-full transition-colors duration-200"
              >
          ...
          <div className="text-center">
            <h4 className="text-lg font-semibold text-rose-400 mb-4">Enlaces Rápidos</h4>
          ...
          <div className="text-center md:text-right">
            <h4 className="text-base md:text-lg font-semibold text-rose-400 mb-4">Contacto</h4>
            <div className="space-y-2 text-gray-300 text-sm md:text-base">
              <p>Los altos de Panorama frente a Michel el veterinario, Güines, Mayabeque</p>
              <p>+53 50171464</p>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-400">
            © {currentYear} Chicas Glam. Todos los derechos reservados.
          </p>
          <p className="text-sm text-gray-500 mt-2">
            Diseñado con ❤️ para realzar tu belleza natural
          </p>
        </div>
      </div>
    </footer>
